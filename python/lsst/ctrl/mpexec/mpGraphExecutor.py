...
class _Job:
    ...
    def start(self, butler, quantumExecutor, startMethod=None):
        ...
        # fork. Unpickling of quantum and taskDef has to happen after butler,
        # this is why they are pickled manually here.
        butler_pickle = pickle.dumps(butler)
        quantum_pickle = pickle.dumps(self.qnode.quantum)
        taskDef_pickle = pickle.dumps(self.qnode.taskDef)
        ...
        self.process = mp_ctx.Process(
            ...
            args=(quantumExecutor, taskDef_pickle, quantum_pickle, butler_pickle, logConfigState),
    ...
    @staticmethod
    def _executeJob(quantumExecutor, taskDef_pickle, quantum_pickle, butler_pickle, logConfigState):
        ...
        quantumExecutor : `QuantumExecutor`
            Executor for single quantum.
        taskDef_pickle : `bytes`
            Task definition structure in pickled form.
        ...
        taskDef = pickle.loads(taskDef_pickle)
...
class MPGraphExecutor(QuantumGraphExecutor):
    ...
    def __init__(self, numProc, timeout, quantumExecutor, *,
        ...
        # By default use spawn for MacOS and fork for Linux
